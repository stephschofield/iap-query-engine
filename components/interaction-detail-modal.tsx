...
import { MessageSquare, TrendingUp, Clock, CheckCircle, AlertTriangle, User, Headphones } from "lucide-react"
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-6xl h-[90vh] flex flex-col">
        <DialogHeader className="flex-shrink-0">
          ...
          <DialogDescription>
            Detailed transcript and coaching analysis for {interaction.agentName} - {interaction.date}
          </DialogDescription>
        </DialogHeader>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        ...
                        <Badge variant={interaction.crosstalkScore > 5 ? "destructive" : "secondary"}>
                          {interaction.crosstalkScore}%
                        </Badge>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm">Nontalk</span>
                        <Badge variant={interaction.nontalkScore > 10 ? "destructive" : "secondary"}>
                          {interaction.nontalkScore}%
                        </Badge>
                      </div>
                    </div>
                  </CardContent>
